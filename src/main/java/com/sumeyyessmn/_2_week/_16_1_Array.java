...
public class _16_1_Array {
    ...
    public static void arrayMethod7() {
        ...
        if(index>=0){
            System.out.println(searchCity+SpecialColor.BLUE   +" ili bulunmaktadır"+SpecialColor.RESET);
        }else{
            System.out.println(searchCity+SpecialColor.RED +" ili yoktur"+SpecialColor.RESET);
        }
    }
    /// //////////////////////////////////////////////////////////////
    // Random Number
